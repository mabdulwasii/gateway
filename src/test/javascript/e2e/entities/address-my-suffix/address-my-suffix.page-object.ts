...
import AddressUpdatePage from './address-my-suffix-update.page-object';

const expect = chai.expect;
export class AddressDeleteDialog {
  deleteModal = element(by.className('modal'));
  private dialogTitle: ElementFinder = element(by.id('apiGatewayApp.address.delete.question'));
...
export default class AddressComponentsPage {
  ...
  title: ElementFinder = element(by.id('address-my-suffix-heading'));
  ...
  async goToPage(navBarPage: NavBarPage) {
    await navBarPage.getEntityPage('address-my-suffix');
  ...
  async deleteAddress() {
    ...
    expect(await addressDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/apiGatewayApp.address.delete.question/);
