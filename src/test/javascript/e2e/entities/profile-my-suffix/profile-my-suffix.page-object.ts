...
import ProfileUpdatePage from './profile-my-suffix-update.page-object';

const expect = chai.expect;
export class ProfileDeleteDialog {
  deleteModal = element(by.className('modal'));
  private dialogTitle: ElementFinder = element(by.id('apiGatewayApp.profile.delete.question'));
...
export default class ProfileComponentsPage {
  ...
  title: ElementFinder = element(by.id('profile-my-suffix-heading'));
  ...
  async goToPage(navBarPage: NavBarPage) {
    await navBarPage.getEntityPage('profile-my-suffix');
  ...
  async deleteProfile() {
    ...
    expect(await profileDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/apiGatewayApp.profile.delete.question/);
