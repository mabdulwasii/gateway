...
public class AddressResourceIT {
    ...
    private static final String DEFAULT_LOCAL_GOVT = "AAAAAAAAAA";
    private static final String UPDATED_LOCAL_GOVT = "BBBBBBBBBB";
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getLocalGovt()).isEqualTo(DEFAULT_LOCAL_GOVT);
    ...
    public void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].localGovt").value(hasItem(DEFAULT_LOCAL_GOVT)))
    ...
    public void getAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses/{id}", address.getId()))
            ...
            .andExpect(jsonPath("$.localGovt").value(DEFAULT_LOCAL_GOVT))
    ...
    public void updateAddress() throws Exception {
        ...
        assertThat(testAddress.getLocalGovt()).isEqualTo(UPDATED_LOCAL_GOVT);
