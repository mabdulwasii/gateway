...
public class WalletAccountResource {
	...
	public WalletAccountResource(WalletAccountService walletAccountService, ProfileService profileService,
			UserRepository userRepository, PasswordEncoder passwordEncoder, RITSService rITSService,
			ExternalRESTClient2 externalRESTClient2,TransProducer producer) {
	...
	public ResponseEntity<WalletAccountDTO> createWalletAccount(@RequestBody WalletAccountDTO walletAccountDTO)
	...
	public Object validateBvn(@RequestBody BvnDTO bvnDTO) {
		...
		headers.put("X-API-PUBLIC-KEY",
				"U09MRHwyNjk5MzI0MjIzfGRiMjZlNjY5NDVjOGQxMjVjMjBkNzIwZWQ2NTE1ZTgxNTEwNzEyMGRiZGQ3MzZlOTIyYzk1MzA1ZjM4YjM2ZTk5MDUxYTE1YmZhZTc4MDcyM2VmZWU5NGQ0MzM1YmM0NzYxMzJjNDk3M2YzMWI5NWMyOWY5OWUwNDEwMWNjOTEx");
